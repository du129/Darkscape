...
public class FaladorEnemies {
    ...
    static String[] names = new String[]{"Highwayman", "White Knight", "Air Wizard", "Earth Wizard", "Fire Wizard", "Water Wizard", "Gambler", "Drunken Man"};
